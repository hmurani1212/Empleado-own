...
export const attendanceColorData = [
  ...
  {id:2, title:'Holiday', color:'#f8c038', att:'H'},
  {id:3, title:'Absent', color:'#ff5e5e', att:'A'},
  {id:4, title:'Leave', color: '#864bff', att:'L'},
  ...
  {id:9, title:'Leave Request', color:'#008000', att:'LR'},
