...
export const SidebarTabs = [
    { id: 1, tabName: 'Dashboard', icon: role === "Admin" ? <BsSpeedometer2 /> : <GoHomeFill />, roles: ['Admin', 'Employee'] },
    { id: 2, tabName: 'Attendance', icon: <FaUserCheck />, roles: ['Employee'] },
    { id: 3, tabName: 'Employees', icon: <HiUser />, roles: ['Admin'] },
    { id: 4, tabName: 'Departments', icon: <HiUserGroup />, roles: ['Admin'] },
    { id: 5, tabName: 'Branches', icon: <BsFillBuildingFill />, roles: ['Admin'] },
    { id: 6, tabName: 'HR Policies', icon: <FaUserClock />, roles: ['Admin'] },
    { id: 7, tabName: 'Payroll', icon: <FaFileInvoiceDollar />, roles: ['Admin'] },
    { id: 8, tabName: 'Notices', icon: role === "Admin" ? <HiOutlineSpeakerphone /> : <HiSpeakerphone />, roles: ['Admin', 'Employee'] },
    { id: 9, tabName: 'Tasks', icon: role === "Admin" ? <AiFillFile /> : <MdTask />, roles: ['Admin', 'Employee'] },
    ...
    { id: 23, tabName: 'Expense', icon: <AiFillDollarCircle />, roles: ['Employee'] },
    { id: 18, tabName: 'Time Adjustment', icon: <IoIosTime />, roles: ['Employee'] },
    { id: 19, tabName: 'Applications', icon: <PiNotebookFill />, roles: ['Employee'] },
    { id: 20, tabName: 'Payslip', icon: <FaMoneyCheckDollar />, roles: ['Employee'] },
    { id: 21, tabName: 'Duties', icon: <BsFillHandbagFill />, roles: ['Employee'] },
    { id: 15, tabName: 'Notes Pool', icon: role === "Admin" ? <AiFillFile /> : <FaFolderOpen />, roles: ['Admin', 'Employee'] },
    { id: 16, tabName: 'Performance', icon: role === "Admin" ? <BsGraphUpArrow /> : <FaPersonSnowboarding />, roles: ['Admin', 'Employee'] },
    { id: 17, tabName: 'Form & Approval', icon: <FaClipboardCheck />, roles: ['Admin'] },
    { id: 24, tabName: 'Expense', icon: <FaFileInvoiceDollar />, roles: ['Admin'] },
    { id: 22, tabName: 'Profile', icon: <FaUserAlt />, roles: ['Employee'] },
    { id: 25, tabName: 'Training', icon: <FaPersonChalkboard />, roles: ['Admin'] },
    { id: 26, tabName: 'Training', icon: <FaPersonChalkboard />, roles: ['Employee'] },
