...
const useExtraAttendanceServices = ()=>{
    ...
    const viewPolicyData = [
        ...
        {id:16, title:'Policy Swap', icon: <FaExchangeAlt />, data: viewPolicy.policy_swapped_from != null ? `${viewPolicy.policy_swapped_from} ⇄ ${viewPolicy.id ?? viewPolicy.policy_name ?? '-'}` : (viewPolicy.swap_policy && viewPolicy.swap_policy !== '[]' ? viewPolicy.swap_policy : '-') },
