...
const useExtraAttendanceServices = ()=>{
    ...
    const viewPolicyData = [
        ...
        {id:10, title:'Leave Assigned Group', icon: <FaUsers />, data: viewPolicy.leave_group },
        ...
        {id:16, title:'Policy Swap', icon: <FaExchangeAlt />, data: viewPolicy.swap_policy === '[]' ? viewPolicy.swap_policy : '-' },
