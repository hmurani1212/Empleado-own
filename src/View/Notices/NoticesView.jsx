...
import { FaBullhorn, FaHome, FaUserAlt, FaRegCalendarAlt } from "react-icons/fa";
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <div className='flex items-center gap-2 text-gray-500 text-sm'>
                                    <span className="bg-gray-100 px-2 py-0.5 rounded text-xs font-medium">#{viewNoticeData.id}</span>
                                    <span>•</span>
                                    <div className='flex items-center gap-1.5'>
                                        <FaRegCalendarAlt size={12} />
                                        <span>{formatTimestamp(viewNoticeData.timestamp)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className='p-6 space-y-6'>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        <div className='flex items-center gap-3 mb-2'>
                            ...
                            <span className="text-sm font-semibold text-gray-700 font-poppins">Target Audience</span>
                        </div>
                        <div className="ml-11">
                    ...
                    <div>
                        <div className='flex items-center gap-3 mb-3'>
                            ...
                            <span className="text-sm font-semibold text-gray-900 font-poppins">Description</span>
                        </div>
                        <div className="pl-11">
