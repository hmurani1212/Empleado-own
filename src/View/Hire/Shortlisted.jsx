...
const Shortlisted = () => {
  ...
  const goToApplicantPage = (page) => {
    get_allApplicants(vacancyId, { ...applicantActiveFilters, page }, "1", "Shortlisted");
  };
  ...
  // console.log("allShortlistedApp", allShortlistedApp)
  return (
    <>
          ...
          <div className="bg-white rounded-xl shadow-card border border-gray-100 overflow-hidden">
            <div className="min-h-[calc(100vh-100px)] overflow-auto customScroll">
              <table className="w-full text-left">
                ...
                <ConfirmationDialog
                  openDialog={dialogUnshortlist}
                  handleOpen={handleDialogUnShort}
                  handleConfirm={() => unShortlist()}
                  title={"Confirm Unshortlist"}
                  // loading = { loading }
                  message={"Are you sure to Unshortlist this notice?"}
                />
                ...
                <CustomDialog
                  ...
                  handleOpenDialog={handleDialogScore}
                  handleOpen={() => setDialogScore(false)}
                  handleConfirm={handleInterviewScore}
                  title={"Interview Score"}
                  compo={
                    <InterviewScoreComp
                      handleChangeRating={handleChangeRating}
                      scoreInterview={scoreInterview}
                      handleChangeShortlist={handleChangeShortlist}
                    />
                  }
                  showBtns={true}
