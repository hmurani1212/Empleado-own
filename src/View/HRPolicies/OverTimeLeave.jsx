...
const OverTimeLeave = (props) => {
  ...
  const weekendType = newhrPolicesValues?.weekendoverTime?.value;
  const showWeekendRateFields = [1, 2, 3, 4, 5].includes(weekendType);
          ...
          <div className="flex flex-col gap-4 max-w-md mx-auto">
              ...
              <div className="flex items-center gap-1.5 mb-1">
                ...
                {openContentDrawer && (
                  <FaInfoCircle
                    ...
                    onClick={() => openContentDrawer("DAILYOVERTIME_HRPOLICY_EMP")}
                  />
                )}
              </div>
              <CustomSelect
            ...
            {newhrPolicesValues.overTimeCounter?.value === 1 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 animate-fade-in-up">
                <div className="w-full">
                  <label className="text-sm font-medium text-gray-700 font-poppins mb-1 block">
                    Overtime Start Threshold
                  </label>
                  <input
                    className="w-full px-3 py-2 bg-white border border-gray-200 rounded-xl text-sm font-poppins text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400 transition-all placeholder:text-gray-400"
            ...
            <div className="w-full">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                {openContentDrawer && (
                  <FaInfoCircle
                    className="text-gray-400 text-sm cursor-pointer hover:text-[#3DA5F4] shrink-0"
                    onClick={() => openContentDrawer("HOLIDAYOVERTIME_HRPOLICY_EMP")}
                  />
                )}
              </div>
              <CustomSelect
            ...
            <div className="w-full">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                {openContentDrawer && (
                  <FaInfoCircle
                    className="text-gray-400 text-sm cursor-pointer hover:text-[#3DA5F4] shrink-0"
                    onClick={() => openContentDrawer("LEAVEMANAGMENT_HRPOLICY_EMP")}
                  />
                )}
              </div>
              <CustomSelect
