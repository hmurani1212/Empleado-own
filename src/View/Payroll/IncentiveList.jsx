      ...
      <div className="p-2 flex flex-col space-y-4 bg-white rounded-[10px] drop-shadow-md p-2">
        ...
        <div className="">
          <table className="w-full text-center">
            ...
            <tbody>
              {allIncentList.length > 0 ? (
                allIncentList?.map((data, index) => {
                  const isLast = index === allIncentList.length - 1;
                    ...
                    <tr key={index}>
                      ...
                      <td className={classes}>
                        ...
                        >
                          {(() => {
                            console.log(
                              "IncentiveList - Full data object:",
                              data
                            );
                            console.log(
                              "IncentiveList - data.status:",
                              data.status,
                              "type:",
                              typeof data.status
                            );
                            console.log("IncentiveList - Comparison results:", {
                              'data.status === "ACTIVE"':
                                data.status === "ACTIVE",
