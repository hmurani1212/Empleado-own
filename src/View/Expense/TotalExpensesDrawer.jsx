...
const TotalExpensesDrawer = ({ closeDrawer, totalExpenses = [], totalExpensesLoading = false }) => {
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className={`text-[12px] w-20 font-Urbanist font-medium px-2 py-1 rounded-full ${getStatusStyle(expense.status)}`}>
...
export default TotalExpensesDrawer;
