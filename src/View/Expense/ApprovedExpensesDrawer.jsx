...
const ApprovedExpensesDrawer = ({ closeDrawer, approvedExpenses = [], approvedExpensesLoading = false }) => {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-64 p-6 text-center">
        ...
        <Typography variant="small" color="gray" className="text-gray-500">
          There are no approved expenses to display at the moment.
        </Typography>
      </div>
    );
  }
...
export default ApprovedExpensesDrawer;
