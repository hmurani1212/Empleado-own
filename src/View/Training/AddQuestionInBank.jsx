    ...
    <div className='flex flex-col gap-4 p-6'>
      ...
      <div className='flex items-center gap-4 mb-2'>
        ...
        >
          ...
          <span className='text-[16px] font-medium'>Back to Question Bank</span>
        </button>
      </div>
      ...
      {courseName && (
        <div className='pb-2 border-b border-gray-200'>
          <Typography className='text-[14px] text-gray-600'>
            Course: <span className='font-semibold text-[#474747]'>{courseName}</span>
          </Typography>
        </div>
      )}
      ...
      <div className='flex gap-3 justify-between pt-4 border-t border-gray-200'>
        ...
        >
          {isLoadingAddQuestionsBank ? 'Submitting...' : 'Submit Questions'}
        </Button>
      </div>
    </div>
  )
