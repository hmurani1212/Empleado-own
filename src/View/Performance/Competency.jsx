...
const Competency = () => {
  ...
  useLayoutEffect(() => {
    gettingPRCSelect();
    // eslint-disable-next-line react-hooks/exhaustive-deps -- mount: cycles + competency list
  }, []);
          ...
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
              <div className="w-full md:w-64">
                <CustomSelect
                  placeHolderTitle={competencyValue.performanceListLoading ? "Loading cycles..." : "Filter by Performance"}
                  ...
                  customStyles={false}
                  menuLoading={competencyValue.performanceListLoading}
            ...
            compo={
              addCompetencyValue.show ? (
                <AddCompetency
                  ...
                  performanceListLoading={competencyValue.performanceListLoading}
