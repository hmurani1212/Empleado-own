...
const PayslipDisplay = ({ monthYear, selectedDate, payslipData, onClose }) => {
  ...
  console.log('PayslipDisplay - Processed displayData:', displayData);
  console.log('PayslipDisplay - Deductions:', deductions);
  console.log('PayslipDisplay - Incentives:', incentives);
  ...
  const downloadPDF = async () => {
    ...
    try {
      const canvas = await html2canvas(payslipRef.current, {
        scale: 3, // Higher scale for better quality and readability
        useCORS: true,
        allowTaint: true,
        ...
        <div className="relative mb-4">
          ...
          <div className="flex justify-between items-start pt-6">
            ...
            <div className="w-24 h-24">
              <img 
                src="https://emp-beta.veevotech.com/files/images/4d513d3d/15_logo-5838-1642596925.png" 
                alt="Company Logo"
                style={{ height: '65px' }}
