...
const EmpLoanApplication = (props) => {
    const { loanApplicationValue, addEmpLoanApplication, handleApplicationChange } = props
    
    return (
        <form className='space-y-4' onSubmit={addEmpLoanApplication}>
            ...
            <div className='space-y-2'>
                <CustomButton 
                    title='Submit'
                    loading={loanApplicationValue.loading}
                />
            </div>
        </form>
    )
...
export default EmpLoanApplication
